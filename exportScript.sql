...
drop table if exists USUARIO;
create table LOLPLAYER (playerId bigint, playerLevel bigint, playerName varchar(255), playerStatus varchar(255), lolregion varchar(255), lolrole varchar(255), id_usuario integer not null, primary key (id_usuario)) engine=MyISAM;
create table LOLTEAM (id_time integer not null auto_increment, status_time varchar(255), bottom bigint, jungler bigint, mid bigint, support bigint, top bigint, primary key (id_time)) engine=MyISAM;
create table USUARIO (id_usuario integer not null auto_increment, email varchar(255), login varchar(255), nome varchar(255), password varchar(255), primary key (id_usuario)) engine=MyISAM;
alter table LOLPLAYER add constraint UK_6m1phtrdwg2ge1wcpig3hk54p unique (playerId);
alter table USUARIO add constraint UK_fiaj0vs5nduv6knel78ihnfs3 unique (login);
alter table LOLPLAYER add constraint FK39g70tnggfh74crwesc24doyk foreign key (id_usuario) references USUARIO (id_usuario);
alter table LOLTEAM add constraint FKabev227npn1n31sol22ick9lc foreign key (bottom) references LOLPLAYER (playerId);
alter table LOLTEAM add constraint FKcqulsmxargvhluvlmwct5g76w foreign key (jungler) references LOLPLAYER (playerId);
alter table LOLTEAM add constraint FKaoov74sytd13ujrcu4hw8hxh1 foreign key (mid) references LOLPLAYER (playerId);
alter table LOLTEAM add constraint FKmj31cuvd5cjfghoc9rkbe5t0n foreign key (support) references LOLPLAYER (playerId);
alter table LOLTEAM add constraint FKoyn3jhjfan1i06ubrhs8jtjqj foreign key (top) references LOLPLAYER (playerId);
drop table if exists LOLPLAYER;
drop table if exists LOLTEAM;
drop table if exists USUARIO;
create table LOLPLAYER (id_player integer not null auto_increment, gamePlayerID bigint, playerLevel bigint, playerName varchar(255), playerStatus varchar(255), lolregion varchar(255), lolrole varchar(255), primary key (id_player)) engine=MyISAM;
